...
class HeaderStyle {
  // TODO add menu on tap
  final VoidCallback onMenuTapped;

  // TODO add search icon  ontap
  ...
  const HeaderStyle({
    ...
    this.onMenuTapped = null,
    this.onSearchTapped = null,
    ...
    this.leftChevronIcon = const Icon(Icons.menu_rounded),
    this.rightChevronIcon = const Icon(Icons.search_rounded),
