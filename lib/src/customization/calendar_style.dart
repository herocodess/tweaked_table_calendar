...
class CalendarStyle {
  ...
  // TODO add list of colors to be randomized
  ...
  const CalendarStyle({
    ...
    this.weekendStyle = const TextStyle(color: const Color(0xFF263238)), // Material red[500]
    this.holidayStyle = const TextStyle(color: const Color(0xFF263238)), // Material red[500]
    ...
    this.outsideWeekendStyle = const TextStyle(color: const Color(0xFF263238)), // Material red[200]
    this.outsideHolidayStyle = const TextStyle(color: const Color(0xFF263238)), // Material red[200]
